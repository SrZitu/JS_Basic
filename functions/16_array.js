...
//that pass the test implemented by the provided function. Here's an example: it return an new array

const numbers = [1, 2, 3, 4, 5];
const filteredNumbers = numbers.filter((number) => number > 3);
console.log(filteredNumbers); // Output: [4, 5]

// find(): The find() method is used to return the value of the first element in an array
//that satisfies the provided testing function. Here's an example:
//it returns a single value. condition satifies korbe jara tader first element return korbe sudhu
...
//it gives new array. Jei array te apply korbo setar upor function cahalay array mofify korte help kore
//and complete new array return kore.
//     Example:
...
// const sum = numbers4.reduce((accumulator, currentValue) => accumulator * currentValue,1); 
// //1 holo initial value.initial value jekono kisu set kore dite pari.
